...
public class GraficaFDEN extends JFrame {

	private static final long serialVersionUID = 1L;
	private LinkedList<Punto2D> puntitos1;
	private LinkedList<Punto2D> puntitos2;
	
    public GraficaFDEN(LinkedList<Punto2D> puntitos1, LinkedList<Punto2D> puntitos2) {

        super("Función de Densidad");
    ...
    private XYDataset createDataset() {
        ...
        for(int i=0;i<this.puntitos2.size(); i++){
